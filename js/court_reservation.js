        ...
        fetch('search_courts.php', {
            ...
            .then(data => {
                ...
                document.getElementById("returnToSearch").addEventListener('click', function() {
                    ...
                    <a href="#">
                        <img class="rounded-t-lg" src="https://static8.depositphotos.com/1009701/893/i/450/depositphotos_8930781-stock-photo-tennis-court.jpg" alt="product image" />
                    </a>
                    <div class="p-2.5">
                        <p class="text-lg font-semibold text-gray-900 dark:text-white">${court.court_name}</p>
                        <div class="flex items-center pb-1 justify-between text-center">
                            ...
                            <p class="text-sm text-center">
                                <span class="text-sm text-gray-900 flex items-center justify-center">
                                    <i class='bx bx-tennis-ball mr-1'></i>${court.court_type}
                                </span>
                            </p>
                        </div>
                        <div class="flex items-center pb-1 justify-between text-center">
                        ...
                        <div class="flex items-center pb-1 justify-between text-center pt-2">
                            <span class="text-3xl font-bold text-gray-900 dark:text-white">$${court.price_per_hour}</span>
                            <button class="book-now-btn text-center text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-1 text-center" data-court-name="${court.court_name}" data-court-price="${court.price_per_hour}"> Book Now
